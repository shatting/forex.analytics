 ...
 * settings
 */
    BinaryTreeGeneticAlgo(int selectNumber, double leafValueMutation, double leafValueSignMutation, double logicalNodeMutation, double leafValueIndicatorMutation, double crossover);
 ...
 */
    void Select(std::vector<BinaryTreeChromosome *> *newGeneration, std::vector<BinaryTreeChromosome *> *oldGeneration, unsigned size);
 ...
 */
    void
    Mutate(std::vector<BinaryTreeChromosome *> *chromosomeInput, unsigned index, BinaryTreeChromosome *outputChromosome, double leafValueMutationProbability, double leafValueSignMutationProbability, double logicalNodeMutationProbability,
           double crossoverProbability, double leafIndicatorMutationProbability);
 ...
 * nodes
 */
    void Crossover(BinaryTreeChromosome *left, BinaryTreeChromosome *right);
};
