 ...
 *                   tree nodes
 */
    void createRandom(int height, const std::vector<std::string> &indicatorNames, const std::unordered_map<std::string, double> &indicatorMin, const std::unordered_map<std::string, double> &indicatorMax);

    void Mutate(double leafValueMutationProbability, double leafValueSignMutationProbability, double logicalNodeMutationProbability, double crossoverProbability, double leafIndicatorMutationProbability, TreeNode *node);

    void Mutate(double leafValueMutationProbability, double leafValueSignMutationProbability, double logicalNodeMutationProbability, double crossoverProbability, double leafIndicatorMutationProbability);
